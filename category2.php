...
<head>
    ...
    <title>Author's Collection</title>
</head>
...
<body>
    ...
    <main>
        <h1 class="text-center headingPro" style="font-size:8rem;">Author's Collection</h1>
        <h4 class="text-center">Penned by the finest!</h4>
        ...
        <section class="py-5">
            ...
            <div class="container">
                <div class="product-items">
                    ...
                    $sql = "SELECT * FROM `products` WHERE `tag`='$tag'";
