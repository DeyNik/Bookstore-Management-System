...
<section class="footer">
      <div class="box-container row px-5 py-5">
        ...
        <div class="boxx first col-lg-3 py-3 px-5 text-center">
          ...
          <p>For the love of Books, we at BOOK STORE® are providing you so many services from your tiny
            litle screen anywhere and anytime you want. Now you can express your love for these beautiful books
        ...
        <div class="boxx col-lg-3 d-flex flex-column text-center text-uppercase py-3">
          ...
          <a href="Feedback_Form.php" class="py-1">Feedback</a>
        </div>
        <div class="boxx col-lg-3 d-flex flex-column text-center text-uppercase py-3">
          <h3>Categories</h3>
          <?php
 ...
 <!--<h1 class="credit text-center text-uppercase pb-3 px-2 feedform" style="text-align:center;  color: rgb(85,150,162)"> <a href="Feedback_Form.html">Feedback Form</a> </h1>
      -->
      <div class="mb-0">
     
	  <h1 class="credit text-center text-uppercase pb-3 px-2"> © 2022 BookStore® | All Rights Reserved</h1>
